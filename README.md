...
e aplica as migrações quando necessário.  As migrações são scripts SQL que estão localizados no
...
de uma migração que cria a tabela medico.  Quando você inicia sua aplicação, o Flyway verifica o estado atual
